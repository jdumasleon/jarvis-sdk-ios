...
public struct DSCard<Content: View>: View {
    ...
    private var backgroundColor: Color {
        ...
        case .filled:
            return DSColor.Surface.backgroundSecondary
        case .transparent:
            return Color.clear
        }
    }
...
public struct DSStatusCard: View {
    public enum Status {
        ...
        var color: Color {
            ...
            case .neutral: return DSColor.Neutral.neutral500
            }
        }
        ...
        var backgroundColor: Color {
            ...
            case .neutral: return DSColor.Neutral.neutral50
            }
        }
                ...
                Section("List Card") {
                    DSListCard(items: [
                        .init(
                            ...
                            trailing: AnyView(Text("1.2KB").setTextStyle(.labelSmall)),
                            action: { }
                        ),
                        .init(
                            ...
                            trailing: AnyView(Text("512B").setTextStyle(.labelSmall)),
                            action: { }
                        ),
                        .init(
