...
public struct DSIcons {
    ...
    public struct Jarvis {
        ...
        public static let preferencesFilled = Image(systemName: "slider.horizontal.3")
...
public struct DSIconButton: View {
    ...
    private var foregroundColor: Color {
        ...
        case .primary, .secondary, .destructive:
            return isEnabled ? DSColor.Text.onPrimary : DSColor.Text.disabled
        case .ghost:
            return isEnabled ? DSColor.Text.primary : DSColor.Text.disabled
        }
    }
}
