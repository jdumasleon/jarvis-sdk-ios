...
public extension View {
    // MARK: - Border Extensions
    func dsBorder(_ color: Color = DSColor.Neutral.neutral20, width: CGFloat = DSBorderWidth.regular) -> some View {
        overlay(
    ...
    func dsBorder(_ color: Color = DSColor.Neutral.neutral20, width: CGFloat = DSBorderWidth.regular, radius: CGFloat) -> some View {
        overlay(
