...
public struct DSTextField: View {
    ...
    public enum InputState {
        ...
        var borderColor: Color {
            switch self {
            case .normal: return DSColor.Surface.border
            case .focused: return DSColor.Primary.primary100
            case .error: return DSColor.Error.error100
            case .disabled: return DSColor.Neutral.neutral300
        ...
        var backgroundColor: Color {
            switch self {
            case .disabled: return DSColor.Neutral.neutral100
            default: return DSColor.Surface.surface
            }
        }
    }
...
public struct DSToggle: View {
    ...
    private var labelColor: Color {
        isDisabled ? DSColor.Text.disabled : DSColor.Text.primary
    }
}
...
public struct DSPicker<SelectionValue: Hashable>: View {
    ...
    private var labelColor: Color {
        isDisabled ? DSColor.Text.disabled : DSColor.Text.secondary
    }
}
